 ...
 * @author Sujay Busam filled in missing code for CS10 PS-3
 */
import java.awt.*;
...
public class Editor extends JApplet {
  ...
  private class RedButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
    	cmd = new ColorCmd(Color.red, dwg);
  ...
  private class GreenButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
    	cmd = new ColorCmd(Color.green, dwg);
  ...
  private class BlueButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent event) {
    	cmd = new ColorCmd(Color.blue, dwg);
